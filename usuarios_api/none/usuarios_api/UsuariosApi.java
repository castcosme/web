 ...
 * on 2017-12-06 at 06:23:42 UTC 
 * Modify at your own risk.
 */

package none.usuarios_api;
...
public class UsuariosApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class User {
     ...
     *
     * @param content the {@link none.usuarios_api.model.MessagesUserUpdate}
     * @return the request
     */
    public Update update(none.usuarios_api.model.MessagesUserUpdate content) throws java.io.IOException {
      Update result = new Update(content);
      initialize(result);
      return result;
    }

    public class Update extends UsuariosApiRequest<none.usuarios_api.model.MessagesCodeMessage> {
       ...
       * @since 1.13
       */
      protected Update(none.usuarios_api.model.MessagesUserUpdate content) {
        super(UsuariosApi.this, "POST", REST_PATH, content, none.usuarios_api.model.MessagesCodeMessage.class);
      }
  ...
  public class Users {
     ...
     *
     * @param content the {@link none.usuarios_api.model.MessagesTokenKey}
     * @return the request
     */
    public Get get(none.usuarios_api.model.MessagesTokenKey content) throws java.io.IOException {
      Get result = new Get(content);
      initialize(result);
      return result;
    }

    public class Get extends UsuariosApiRequest<none.usuarios_api.model.MessagesUserList> {
       ...
       * @since 1.13
       */
      protected Get(none.usuarios_api.model.MessagesTokenKey content) {
        super(UsuariosApi.this, "POST", REST_PATH, content, none.usuarios_api.model.MessagesUserList.class);
      }
     ...
     *
     * @param content the {@link none.usuarios_api.model.MessagesEmailPasswordMessage}
     * @return the request
     */
    public Login login(none.usuarios_api.model.MessagesEmailPasswordMessage content) throws java.io.IOException {
      Login result = new Login(content);
      initialize(result);
      return result;
    }

    public class Login extends UsuariosApiRequest<none.usuarios_api.model.MessagesTokenMessage> {
       ...
       * @since 1.13
       */
      protected Login(none.usuarios_api.model.MessagesEmailPasswordMessage content) {
        super(UsuariosApi.this, "POST", REST_PATH, content, none.usuarios_api.model.MessagesTokenMessage.class);
      }
